const school = [
    {header: "Haaga-Helia University of Applied Sciences (ONGOING)",
     bullets: [
        "Bachelor of Business Information Technology (2020 -> )",
        "Software Production"
    ]},
    {header: "Taitotalo (2020 - 2021)",
    bullets: [
       "Vocational Qualification in Information Technology",
       "Python-programmer"
    ]},
    {header: "University of Turku (2005 - 2012)",
    bullets: [
        "Master of Science (physics)",
        "Main: Materials Science",
        "Minor: Mathemathics, Chemisty, IT"
    ]},
    {header: "Kastu High School, Turku (2002 - 2005)",
    bullets: [
        "Graduate",
